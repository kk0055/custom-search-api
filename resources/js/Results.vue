...
main
    .right-sidebar
    .right-sidebar__top-sec
    .right-sidebar__top-sec--left-heading {
    width: 60%;
    line-height: 0.9;
    margin-top: 1rem;
}
...
main
    .right-sidebar
    .right-sidebar__top-sec
    .right-sidebar__top-sec--right-image {
    width: 14rem;
    height: 13rem;
}
main
...
main
    .right-sidebar
    .right-sidebar__sub-bottom-sec
    .profiles-item-x:last-child
    a,
